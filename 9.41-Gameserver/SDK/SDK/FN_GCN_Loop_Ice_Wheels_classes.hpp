...
public:
	...
	TScriptInterface<class IFortVehicleInterface> TargetVehicleInterface;                            // 0x840(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
