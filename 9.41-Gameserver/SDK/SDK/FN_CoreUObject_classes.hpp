...
public:
	...
	uint8                                        Pad_9[0x44];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_C[0x100];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1B[0xC8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1C[0x1B8];                                     // Fixing Size Of Struct [ Dumper-7 ]
