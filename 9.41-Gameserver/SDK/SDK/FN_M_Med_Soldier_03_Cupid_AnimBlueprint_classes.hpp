...
public:
	...
	struct FAnimNode_Root                        AnimGraphNode_Root_91EDDABE45FF40660C7C398C88D576B7; // 0x518(0x30)(None)
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace_C02AB20348B2B54CFA0C50803C42321A; // 0x548(0x20)(None)
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace_308ADA1248ABA3187DFA7ABFC12BC130; // 0x568(0x20)(None)
	uint8                                        Pad_6678[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FAnimNode_AnimDynamics                AnimGraphNode_AnimDynamics_02B303FA4DDA5584C595D48F2A2D11D1; // 0x590(0x440)(None)
	struct FAnimNode_AnimDynamics                AnimGraphNode_AnimDynamics_B17F58154A349B54BB143CBE152F66E8; // 0x9D0(0x440)(None)
	struct FAnimNode_AnimDynamics                AnimGraphNode_AnimDynamics_4ABFB15A48A29BF94F74F6BBBF5874AF; // 0xE10(0x440)(None)
