...
public:
	...
	TScriptInterface<class IFortVehicleInterface> K2Node_DynamicCast_AsFort_Vehicle_Interface;       // 0x2A0(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	uint8                                        Pad_590A[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_590B[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData;               // 0x368(0xB0)(None)
